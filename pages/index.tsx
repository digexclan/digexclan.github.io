      ...
      <Container>
        <div className="flex mt-8 py-36">
          <div>
            ...
            <div className="flex px-16 w-3/4">
              <div className="text-xl font-medium rounded-xl bg-gradient-to-r from-sky-900  to-sky-700 text-white px-6 py-4 mr-4">
                <Link href="/">Digex 2022 </Link>
              </div>
              <div className="text-xl font-medium rounded-xl bg-gradient-to-r from-sky-900  to-sky-700 text-white px-6 py-4">
        ...
        <div className="flex flex-col jusitfy-center items-center my-12">
          <div className="flex flex-col justify-center items-center mb-8">
            ...
            <div className="text-xl font-medium rounded-xl bg-gradient-to-r from-sky-900  to-sky-700 text-white px-4 py-2">
